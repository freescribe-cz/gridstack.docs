...
[id="grid-option-alwaysshowresizehandle"]
...
[id="grid-option-cellheightthrottle"]
...
[id="grid-option-maxrow"]
maxRow:: _(integer)_
The maximum number of rows.
+
Default: `0` (unlimited)

[id="grid-option-minrow"]
minRow:: _(integer)_
